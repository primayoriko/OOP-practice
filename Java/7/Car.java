...
public class Car {
	...
	*/
	public void fillingFuel(Fuel t_fuel, int amount_in_liter) throws FuelException{
		...
		System.out.printf("Berhasil isi bensin sebanyak %d liter%n", amount_in_liter);
	}
	...
	*/
	public void changeGear(int t_gear) throws InvalidInputCarException{
		...
		this.gear = t_gear;
		System.out.printf("Berhasil mengubah gigi menjadi gigi %d%n", t_gear);
	}
	...
	*/
	public void changeAcPower(int t_ac_power) throws InvalidInputCarException{
		...
		System.out.printf("Berhasil mengubah power ac menjadi %d%n", t_ac_power);
	}
	...
	*/
	public void service(Fuel t_fuel, int amount_in_liter, int t_gear, int t_ac_power){
		...
		// catch (TheCarIsOnException c){
		// 	c.getMessage();
		// } catch (InvalidInputCarException i){
		// 	i.getMessage();
